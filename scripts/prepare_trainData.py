...
Just read all data in stock database and  save.
...
national_debt_file = '../quant-data/中国一年期国债收益率历史数据.csv'
stock_index_file = "../quant-data/上证指数历史数据.csv"

# out_folder = '../stockdata/wukong/'
out_folder = '../stockdata/wukong-220817/'
...
if not os.path.exist(out_folder):
