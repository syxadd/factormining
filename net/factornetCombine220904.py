...
class FactorNetCombine220904(nn.Module):
    def __init__(self, in_features,
                 out_features=1,
                 time_length=30,
                 dropout = 0.0,
                 ):
        super(FactorNetCombine220904, self).__init__()
        self.in_ch = in_features
        ...
        self.param_extraction = nn.Conv1d(in_channels=self.in_ch, out_channels=self.in_ch*7, kernel_size=self.days, stride=self.days)
