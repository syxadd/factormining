...
class FactorNetID17_LearnableShareEncoder220913(nn.Module):
    def __init__(self, in_features,
                 out_features=1,
                 time_length=30,
                 dropout = 0.0,
                 ):
        super(FactorNetID17_LearnableShareEncoder220913, self).__init__()
        self.in_ch = in_features
        ...
        self.encoder = MultiEncoder(self.ch2)
        ...
        self.ch2_out = self.encoder.out_ch * (1+2+3)
    ...
    def forward(self, x):
        ...
        ## enoder
        xfeat10 = self.encoder(xfeat10)
        xfeat15 = self.encoder(xfeat15)
        xfeat30 = self.encoder(xfeat30)
