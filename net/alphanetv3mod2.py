...
class AlphaNetv3GRUmod(nn.Module):
    def __init__(self, in_features,
                 out_features=1,
                 time_length=30,
                 dropout = 0.0,
                 ):
        super(AlphaNetv3GRUmod, self).__init__()
        ...
        self.ch2_out = self.hidden_units * (3 + 6)
    ...
    def forward(self, x):
        ...
        out = torch.cat([xout.flatten(start_dim=1), yout.flatten(start_dim=1)], dim=1)
