...
class FactorNetID15_LargerLevel220911(nn.Module):
    def __init__(self, in_features,
                 out_features=1,
                 time_length=30,
                 dropout = 0.0,
                 ):
        super(FactorNetID15_LargerLevel220911, self).__init__()
        self.in_ch = in_features
        ...
        self.encoder10 = MultiEncoder(self.feat_ch)
        self.encoder15 = MultiEncoder(self.feat_ch)
        self.encoder30 = MultiEncoder(self.feat_ch)


        # self.ch2 = self.ch1 // 16
        self.ch2 = self.encoder10.out_ch
