...
class FactorNetID14_SingleLevel220911(nn.Module):
    def __init__(self, in_features,
                 out_features=1,
                 time_length=30,
                 dropout = 0.0,
                 ):
        super(FactorNetID14_SingleLevel220911, self).__init__()
        self.in_ch = in_features
        ...
        self.ch1 = self.extraction_k9.out_features  + self.in_ch  + self.in_ch
    ...
    def forward(self, x):
        ...
        xout = torch.cat([x1, xfixfactor9, xfeat9], dim=1)
        xout = xout.flatten(start_dim=1)
